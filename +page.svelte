<script>
  ...
  function downloadPNG() {
    const svg = document.querySelector(".shape-preview svg");
    ...
    <div class="toolbar">
      ...
      <label>
        ...
        <select bind:value={svgShape}>
          ...
          <option
            value="M100,100 C150,50 200,150 250,100 C300,50 350,150 400,100"
            >Wave</option
          >
          <option
            value="M150 0 L75 200 L225 200 Q150 300 75 400 Q225 500 150 600 L0 600 Z"
            >Complex</option
          >
      ...
      <div class="dropdown">
        <button class="btn" on:click={toggleDropdown}>Download</button>
        <div class="dropdown-content" class:show={showDropdown}>
          <button on:click={() => handleDownload("svg")}>Download as SVG</button
          >
          <button on:click={() => handleDownload("png")}>Download as PNG</button
          >
        </div>
      </div>
    </div>
