...
<svelte:head>
  ...
  {:else}
    ...
    <meta
      name="title"
      content="Developerstar — A Comprehensive Developer Toolkit"
    />
    <meta
      name="description"
...
>
  <div
    class="w-full px-3 py-3 mx-auto lg:flex lg:justify-between max-w-8xl lg:px-3"
  >
    <Navbar let:hidden let:toggle>
      ...
      <div class="flex items-center w-full lg:w-auto">
        <NavUl {hidden}>
          ...
          <NavLi href="/about" active={$page.url.pathname === "/about"}
            >About</NavLi
          >
          <NavLi href="/contact" active={$page.url.pathname === "/contact"}
            >Contact</NavLi
          >
        </NavUl>
        <div
          class="lg:self-center flex items-center mb-4 lg:mb-0 hidden mr-3 lg:flex"
        >
